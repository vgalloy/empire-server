...
public final class InMemoryTranslationStoreTest {
    ...
    public void franceDefineFrench() {
        ...
        // WHEN
        final Translation translation = translationDao.translate(new TranslationKey("CODE", Locale.FRENCH));
    ...
    public void franceUseFrench() {
        ...
        // WHEN
        final Translation translation = translationDao.translate(new TranslationKey("CODE", Locale.FRANCE));
    ...
    public void addIfMissingDoesNotOverridePreviousValue() {
        ...
        // WHEN
        final Translation translation = translationDao.translate(new TranslationKey("CODE", new Locale("fr", "ze")));
