...
public class FeatureSwitcherModuleBuilder {
  ...
  /**
   * Define the {@link FeatureDao} for the module. Invoking this method twice will override the
   * first invocation
   *
  ...
  /**
   * Define the {@link FeatureAdder} for the module. Invoking this method twice will override the
   * first invocation
   *
  ...
  public FeatureSwitcherModuleConfiguration build() {
    return new FeatureSwitcherModuleConfiguration(
        this.packageScanner, this.featureDao, featureAdder);
  }
}
